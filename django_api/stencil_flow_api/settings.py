"""
Django settings for Stencil Flow API project.
"""
...
WSGI_APPLICATION = 'stencil_flow_api.wsgi.application'

# Database
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': config('DB_NAME', default='stencil_flow'),
...
# Using standard Django User model with Profile extension
