...
urlpatterns = [
    ...
    path('functions/get-ai-token-usage/', views.get_ai_token_usage, name='get_ai_token_usage'),
    path('functions/get-workflow-flowchart/', views.get_workflow_flowchart, name='get_workflow_flowchart'),
